...
public class WtlPrgaPsVO {
	...
	/** pga_cde 수압계종류 */
	private String pga_cde;
	private String pga_cde_nm;
	...
	/** std_saf 기준압력 */
	private String std_saf;
	
	/** avg_saf 평균압력 */
	private String avg_saf;
	
	/** msr_saf 측정압력 */
	private String msr_saf;
	
	/** srv_dip 배수관_관경 */
	private String srv_dip;
	...
	public String getPga_cde() {
		return pga_cde;
	}

	public void setPga_cde(String pga_cde) {
		this.pga_cde = pga_cde;
	}

	public String getPga_cde_nm() {
		return pga_cde_nm;
	}

	public void setPga_cde_nm(String pga_cde_nm) {
		this.pga_cde_nm = pga_cde_nm;
	}
	...
	public String getStd_saf() {
		return std_saf;
	}

	public void setStd_saf(String std_saf) {
		this.std_saf = std_saf;
	}

	public String getAvg_saf() {
		return avg_saf;
	}

	public void setAvg_saf(String avg_saf) {
		this.avg_saf = avg_saf;
	}

	public String getMsr_saf() {
		return msr_saf;
	}

	public void setMsr_saf(String msr_saf) {
		this.msr_saf = msr_saf;
	}

	public String getSrv_dip() {
		return srv_dip;
	}

	public void setSrv_dip(String srv_dip) {
		this.srv_dip = srv_dip;
	}
