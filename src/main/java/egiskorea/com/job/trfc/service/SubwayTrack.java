...
/**
 * @Description 지하철선로를 관리하는 model 클래스
...
public class SubwayTrack implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1581192137816243476L;
	...
	/** 지하철노선명_한글 */
	private String korSbrNm;
	
	/** 작업일시 */
	private String opertDe;
	
	/** 지하철선로일련번호 */
	private int subRlwSn;
	...
	public int getSubRlwSn() {
		return subRlwSn;
	}

	public void setSubRlwSn(int subRlwSn) {
