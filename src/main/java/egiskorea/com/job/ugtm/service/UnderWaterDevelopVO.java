...
/**
 * @Description 지하수관리 > 지하수개발 VO 클래스
...
public class UnderWaterDevelopVO implements Serializable{
	...
	private String underWaterDevelopAreaDrawing;
	private String underWaterDevelopSelect;
	...
	public String getUnderWaterDevelopAreaDrawing() {
		return underWaterDevelopAreaDrawing;
	}

	public void setUnderWaterDevelopAreaDrawing(String underWaterDevelopAreaDrawing) {
		this.underWaterDevelopAreaDrawing = underWaterDevelopAreaDrawing;
	}

	public String getUnderWaterDevelopSelect() {
		return underWaterDevelopSelect;
	}

	public void setUnderWaterDevelopSelect(String underWaterDevelopSelect) {
		this.underWaterDevelopSelect = underWaterDevelopSelect;
	}
