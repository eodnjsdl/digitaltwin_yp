...
public class EgovWebApplicationInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		rootContext.setConfigLocations(new String[] { "classpath*:egovframework/spring/com/**/context-*.xml", "classpath*:egiskorea/spring/com/**/context-*.xml" });
		...
		if("security".equals(EgovProperties.getProperty("Globals.Auth").trim())) {
			...
			//로그인 실패시 반활 될 URL설정
			egovSpringSecurityLoginFilter.setInitParameter("loginURL", "/uat/uia/loginUsr.do");
			//로그인 처리 URL설정
