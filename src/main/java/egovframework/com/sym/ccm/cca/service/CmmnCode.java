...
public class CmmnCode implements Serializable {
	...
	/**
	 * clNmCode attribute 를 리턴한다.
	 * @return String
	 */
	public String getClNmCode() {
		return clNmCode;
	}

	/**
	 * clNmCode attribute 값을 설정한다.
	 * @param clNmCode String
	 */
	public void setClNmCode(String clNmCode) {
		this.clNmCode = clNmCode;
	}
