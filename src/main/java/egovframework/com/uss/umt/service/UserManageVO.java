...
public class UserManageVO extends UserDefaultVO{
	 ...
	 * @param lockCnt String
	 */
	public void setLockCnt(String lockCnt) {
		this.lockCnt = lockCnt;
	}
	/**
	 * emplyrSttusNm attribute 값을  리턴한다.
	 * @return String
	 */
	...
	/**
	 * emplyrSttusNm attribute 값을 설정한다.
	 * @param emplyrSttusNm String
	 */
