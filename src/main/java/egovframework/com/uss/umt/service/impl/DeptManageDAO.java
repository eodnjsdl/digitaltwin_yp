...
public class DeptManageDAO extends EgovComAbstractDAO {
	 ...
	 * 그룹에 따른 부서 목록 조회
	 * @param deptManageVO - 부서 model
	 * @return List - 그룹에 따른 부서 목록
	 * @param deptManageVO
	 */
	
	public List<DeptManageVO> selectGroupDeptAjaxList(DeptManageVO deptManageVO) {
		return selectList("deptManageDAO.selectGroupDeptAjaxList", deptManageVO);
	}
