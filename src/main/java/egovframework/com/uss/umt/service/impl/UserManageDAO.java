...
public class UserManageDAO extends EgovComAbstractDAO{
	...
	public void createUserSchema(String schemaNm) {
		selectOne("userManageDAO.createUserSchema", schemaNm);
	}

	/**
	 * @Description 사용자 삭제 시 스키마 삭제
	 * @Author 플랫폼개발부문 DT솔루션 정상혁
	 * @Date 2022.03.25
	 * @param schemaNm
	 */
	public void deleteUserSchema(String schemaNm) {
		delete("userManageDAO.deleteUserSchema", schemaNm);
	}
