...
<%
/**
 * @file Name : insertOpQnaManageView.jsp
 * @Description : 운영지원 관리 등록 페이지
...
<section id="content">
	<div class="row">
		<div class="col-12 page-tit-wrap">
			<h3 class="page-tit">운영지원 관리2</h3>
			<p class="page-txt">운영지원 관리 페이지입니다.</p>
		</div>
	</div>

	<%--@elvariable id="qnaVO" type="egovframework.com.uss.olh.qna.service.QnaVO"--%>
	<form:form commandName="qnaVO" method="post" action="${pageContext.request.contextPath}/com/mngr/info/insertOpQnaManage.do">
...
s
				...
				<div class="btn-wrap justify-content-between">
					<a href="<c:url value='/com/mngr/info/selectOpQnaManageList.do' />" class="btn basic"><spring:message code="button.list"/></a>
