...
<section id="content">
	...
	<form:form commandName="qnaVO" id="qnaForm" method="post" action="/com/mngr/info/updateQnaManage.do">
			...
			<div class="col-12">
					...
					<table class="bbs-write">
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="3"><c:out value="${egis:nl2br(qnaVO.qestnCn)}" escapeXml="false" /></td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<div class="btn-wrap justify-content-end">
					<div>
						...
						<a href="<c:url value='/com/mngr/info/selectQnaManage.do' />" id="btn-cancel" class="btn type07" title="<spring:message code="button.reset"/> 버튼"><spring:message code="button.reset"/></a>
					</div>
				</div>
			</div>
		</div>
