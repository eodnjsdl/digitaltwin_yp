	...
	chart = new Chart(ctx, { 
		...
		data: { 
			...
			datasets: [{ 
				...
				<!-- content -->
				<section id="content" >
					<form name="listForm" action="<c:url value='/com/mngr/hist/selectUseDailyStatistics.do'/>" method="post">
					<div class="row">
                            ...
                            <div class="tabBoxDepth1-wrap">
								<div class="tabBoxDepth1">
									<ul>
										...
										<li data-tab="tab03" class="on"><button type="button" class="inner-tab" onclick="location.href='/com/mngr/hist/selectUseDailyStatistics.do'">일별 통계</button></li>
