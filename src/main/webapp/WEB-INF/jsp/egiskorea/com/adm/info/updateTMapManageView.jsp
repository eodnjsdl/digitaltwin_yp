...
<%
/**
 * @file Name : updateTMapManageView.jsp
 * @Description : 주제도 관리 수정 페이지
...
<section id="content">
    <div class="row">
        <div class="col-12 page-tit-wrap">
            ...
            <p class="page-txt">주제도를 수정하는 페이지 입니다.</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form:form modelAttribute="themaMapVO" id="themaMap-form" method="post" enctype="multipart/form-data" action="/com/mngr/info/updateTMapManage.do">
                ...
                <div class="btn-wrap justify-content-end">
                    <div>
                        ...
                        <a href="<c:url value='/com/mngr/info/selectTMapManage.do'/>" id="btn-cancel" class="btn type07" title="<spring:message code="button.reset"/> 버튼"><spring:message code="button.reset"/></a><%-- 취소 --%>
                    </div>
                </div>
            </form:form>
        </div>
