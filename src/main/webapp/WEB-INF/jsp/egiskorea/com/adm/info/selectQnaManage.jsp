...
<%
/**
 * @file Name : updateQnaManageView.jsp
 * @Description : Q&A 관리 수정 페이지
...
<section id="content">
	<div class="row">
		<div class="col-12 page-tit-wrap">
			<h3 class="page-tit">Q&A답변 관리</h3>
			<p class="page-txt">Q&A답변 관리 페이지입니다.</p>
		</div>
	</div>
	...
	<div class="row">
		...
		<form:form commandName="searchVO" id="listform" name="listform" method="post" action="/com/mngr/info/updateQnaManageView.do">
				...
				<table class="bbs-detail">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3"><c:out value="${egis:nl2br(result.qestnCn)}" escapeXml="false" /></td>
						</tr>
						<tr>
			...
			<div class="btn-wrap justify-content-between">
				<div>
					<a href="<c:url value='/com/mngr/info/selectQnaManageList.do'/>" class="btn basic btn-list"><spring:message code="button.list"/></a>
				</div>
				<div>
...
<script>
	...
	function fnDeleteQna(qaId){
		if(confirm("<spring:message code="common.delete.msg" />")){
			...
			document.listform.action = "<c:url value='/com/mngr/info/deleteQnaManage.do'/>";
	...
	$(function() {
		...
		$('.btn-restore').click(function() {
			...
			if (confirm("<spring:message code="common.restore.msg" />")) {
				document.listform.qaId.value = qaId;
				document.listform.action = "<c:url value='/com/mngr/info/restoreQnaManage.do'/>";
				document.listform.submit();
			}
		});
