...
$(document).ready(function(){
	...
	$("#ui-datepicker-div").addClass("yearpicker");
	...
	$(".ui-datepicker-trigger").click(function(){
		...
		var date = new Date(Number(year), 1, 1, 0, 0, 0, 0);
	...
	chart = new Chart(ctx, { 
		...
		data: { 
			...
			datasets: [{ 
				...
				<!-- content -->
				<section id="content">
					<form name="listForm" action="<c:url value='/com/mngr/hist/selectUseMonthlyStatistics.do'/>" method="post">
					<div class="row">
						...
						<div class="col-12">
                            ...
                            <div class="tabBoxDepth1-wrap">
								<div class="tabBoxDepth1">
									<ul>
										<li data-tab="tab01"><button type="button" class="inner-tab" onclick="location.href='/com/mngr/hist/selectUseHistoryList.do'">이력조회</button></li>
										...
										<li data-tab="tab04" class="on"><button type="button" class="inner-tab" onclick="location.href='/com/mngr/hist/selectUseMonthlyStatistics.do'">월별 통계</button></li>
									</ul>
								</div>
	                                                   ...
	                                                   <c:when test="${fn:length(resultList) == 0}">
														...
														<c:otherwise>
															<c:forEach items="${resultList}" var="result" varStatus="status">
		                                                            ...
		                                                            <c:forEach items="${result.monthlyList}" var="item" varStatus="status">
		                                                            <td>${item}</td>
		                                                            </c:forEach>
		                                                        </tr>
		                                               	   </c:forEach>			
