    ...
    if(confirm("<spring:message code="common.save.msg" />")){ //저장하시겠습니까?
        if(!validateRoleManage(form)){
        	...
        	form.submit();
				...
				<!-- content -->
				<section id="content">
					<form:form commandName="roleManage" method="post" action="/com/mngr/auth/updateRoleManage.do">
					...
					<div class="row">
						<div class="col-12 page-tit-wrap">
							...
							<p class="page-txt">기능정보를 수정하는 페이지입니다.</p>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="btn-wrap justify-content-between">
								<div></div>
								<div>
									<button type="button" class="btn type02" onclick="fncRoleUpdate(this.form);"><spring:message code="button.update" /></button>
