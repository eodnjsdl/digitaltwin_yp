...
function aj_insertOpQnaView(){
	...
	$.ajax({
		type : "POST",
		url : "/com/opqna/insertOpQnaView.do",
		data : {
			pageIndex : pageIndex,
			searchCnd : searchCnd,
			searchWrd : searchWrd,
					...
					<div class="popup-body">
						<div class="bbs-popup-body">
							...
							<div class="bbs-list-wrap" style="height: 530px;"><!-- pagination 하단 고정을 위해 반드시 필요 -->
								...
								<div class="position-absolute right"><button type="button" class="btn basic bi-write2" onclick="aj_insertOpQnaView()">등록</button></div>
							</div>
						</div>
					</div>
