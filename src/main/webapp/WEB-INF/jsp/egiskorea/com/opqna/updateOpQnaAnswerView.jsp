...
function aj_updateOpQnaAnswer(){
	...
	if (confirm("수정하시겠습니까?")) {
		$.ajax({
			type : "POST",
			url : "/com/opqna/updateOpQnaAnswer.do",
			data : {
				qaId : qaId,
				pageIndex : pageIndex,
				answerCn : answerCn
					...
					<div class="popup-body">
						<div class="bbs-popup-body">
							...
							<div class="position-bottom btn-wrap">
								<div>
									<button type="button" class="btn basic bi-write2" onclick="aj_updateOpQnaAnswer()">수정</button>
									<button type="button" class="btn basic bi-cancel" onclick="aj_selectOpQna()">취소</button>
								</div>
							</div>
						</div>
					</div>
