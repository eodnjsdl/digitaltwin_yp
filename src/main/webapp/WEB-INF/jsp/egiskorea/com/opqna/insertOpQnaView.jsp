						...
						<div class="bbs-popup-body">
							...
							<div class="position-bottom btn-wrap">
								<div>
									...
									<button type="button" class="btn basic bi-cancel" onclick="aj_selectOpQnaList('<c:out value="${searchVO.pageIndex}"/>', '<c:out value="${searchVO.searchCnd}"/>', '<c:out value="${searchVO.searchWrd}"/>')">취소</button>
								</div>
							</div>
						</div>
					</div>
