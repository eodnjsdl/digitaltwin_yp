        ...
        <form:form name="insertFormDron" id="insertFormDron" method="post" onsubmit="insertFormDron(); return false;">
            ...
            <div class="bbs-write-default">
                <table class="bbs-write">
                    ...
                    <tr>
                        <th scope="row">촬영일</th>
                    <td><div class="datapicker-group"><input type="text" id="potogrfDe" name="potogrfDe" class="datepicker"  autocomplete="off"></div></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="border-top-0">
                            <div class="form-file">
                                <input type="file" id="file" accept=".gif,.png,.jpg,.mp4"><input class="upload-name" value=".gif,.png,.jpg,.mp4 파일선택">
