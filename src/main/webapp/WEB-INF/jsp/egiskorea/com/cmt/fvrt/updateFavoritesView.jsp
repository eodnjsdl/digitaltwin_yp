            ...
            <div class="bbs-write-default">
                <table class="bbs-write">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">제목</th>
                            <td colspan="3"><input type="text" class="form-control" name="bkmkNm" value="<c:out value="${result.bkmkNm}" />"></td>
                        </tr>
                        <tr>
                            <th scope="row">등록일</th>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <span class="form-checkbox text">
                                    <span><input type="checkbox" name="ch_bass" id="bass" ${result.bass == "y" ? "CHECKED" : ""}><label for="bass">기본화면으로 저장</label></span>
                                </span>
                            </td>
                        </tr>										
                        <tr>
...
<%--                                            <li><span class="">레이어 : </span> -</li>--%>
            ...
            <div class="position-bottom btn-wrap">
                <div><button type="button" class="btn basic bi-write2">수정</button> <button type="button" class="btn basic bi-cancel">취소</button></div>
            </div>
            </form:form>
        </div>
