            ...
            <div class="bbs-write-default">
                <table class="bbs-write">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="form-radio text group">
                                    <span><input type="radio" name="pnrsAt" id="share1-1" value="0" checked=""><label for="share1-1">공유함</label></span>
                        ...
                        <tr>
                            <th scope="row">위치</th>
                            <td><input type="text" class="form-control" id="loc" style="width: 207px;"> <button type="button" class="btn type01 bi-location">지도에서 선택</button></td>
                        </tr>										
                        <tr>
