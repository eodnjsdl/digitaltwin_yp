        ...
        <form:form name="insertFormMemo" id="insertFormMemo" method="post" onsubmit="insertFormMemo(); return false;">
            ...
            <div class="bbs-write-default">
                <table class="bbs-write">
                    ...
                    <tr>
                        <th scope="row">제목</th>
                        <td colspan="3"><input type="text" class="form-control" id= "sj"name="sj"></td>
                    </tr>
                    <tr>
                        <th scope="row">작성자</th>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                                <span class="form-radio text group">
                                    <span><input type="radio" name="pnrsAt" id="share1-1" checked="" value="0"><label
                    ...
                    <tr>
                        <th scope="row">위치</th>
                        <td colspan="3"><input type="text" class="form-control w-70p" id="loc_memo" readonly>
