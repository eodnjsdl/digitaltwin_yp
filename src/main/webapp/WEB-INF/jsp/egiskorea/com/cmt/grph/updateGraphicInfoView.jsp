	...
	<div class="tool-popup-body top-drawing-body">						
					...
					<tr>
                        ...
                        <td>
                            <span class="form-radio text group">
                                <span><input type="radio" name="pnrsAt" id="drawing_pnrs_y" value="Y"><label for="drawing_pnrs_y">공유함</label></span>
                                <span><input type="radio" name="pnrsAt" id="drawing_pnrs_n" value="N" checked="checked"><label for="drawing_pnrs_n">공유안함</label></span>
                            </span>
                        </td>
                    </tr>
					<tr>
		...
		<div class="tabBoxDepth2-wrap marT15">
			...
			<div class="tab-cont drawingTabPoint on">
				...
				<div class="row symbol-group-row marT20 row_marker">
					<div class="col-left">
		...
		<div class="position-bottom btn-wrap">
			<div><button type="button" class="btn basic bi-write2 btn_save">저장</button> <button type="button" class="btn basic bi-cancel btn_cancel">취소</button></div>
			<div class="position-absolute right"><button type="button" class="btn basic bi-delete btn_remove">삭제</button></div>
		</div>
	</div>
