                    ...
                    <tr>
                        ...
                        <td colspan="3">
                                <span class="form-radio text group">
                                    <span><input type="radio" name="pnrsAt" id="share1-1" value="Y"
                                                 <c:if test="${result.pnrsAt == 'Y'}">checked</c:if>><label
                                            for="share1-1">공유함</label></span>
                                    <span><input type="radio" name="pnrsAt" id="share1-2" value="N"
                                                 <c:if test="${result.pnrsAt == 'N'}">checked</c:if>><label
