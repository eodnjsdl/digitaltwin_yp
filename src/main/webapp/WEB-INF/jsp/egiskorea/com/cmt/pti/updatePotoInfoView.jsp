            ...
            <div class="bbs-write-default">
                <table class="bbs-write">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">위치</th>
                            <td colspan="3"><input type="text" class="form-control" id="loc_poto" style="width: 215px;"> <button type="button" class="btn type01 bi-location">지도에서 선택</button></td>
                        </tr>	
                        <tr>
                            <th scope="row">사진등록</th>
                            <td colspan="3">
                                <div class="form-file"> 													
                                    <input type="file" id="file" multiple accept=".png, .jpg, .jpeg"><input class="upload-name" value="파일선택">
            ...
            <div class="data-default" style="height: 397px;">
                <table class="data-list">
                    ...
                    <thead>
                        <tr>
                            <th scope="col">
                                <span class="form-checkbox"><span><input type="checkbox" name="potoAll" id="potoAll"><label for="potoAll"></label></span></span>
                            </th>
                            <th scope="col">파일</th>
                            <th scope="col">설명</th>
                        </tr>
                    ...
                    <table class="data-list">
                        ...
                        <tbody id="potoImgUpdateList">
                            <c:forEach var="resultFile" items="${resultFile}" varStatus="status">
                                <tr>
                                    <td class="align-center"><span class="form-checkbox"><span><input type="checkbox" name="potoCheck" value="<c:out value="${status.index}" />" id="potoCheck<c:out value="${status.index}" />"><label for="potoCheck<c:out value="${status.index}" />"></label></span></span></td>
                                    <td class="text-overflow"><c:out value="${resultFile.orignlFileNm}"/></td>
                                    <td><input type="text" class="form-control" name="fileCn" value="<c:out value="${resultFile.fileCn}"/>"></td>
