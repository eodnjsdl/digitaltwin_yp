...
<script>
    ...
    function moveBySelectFvrtView() {
        ...
        let center = [pointX, pointY];
        // map2d.view.setCenter(center);
        // map2d.view.setZoom(zoom);

        if (dtmap.crs !== 'EPSG:5179') {
            center = ol.proj.transform(center, 'EPSG:5179', dtmap.crs);
        }
                    ...
                    <td colspan="3">
                                <span class="form-checkbox text">
                                    <span><input type="checkbox" name="ch_bass"
                                                 id="bass" ${result.bass == "y" ? "CHECKED" : ""} disabled><label
                ...
                <tr>
                    <td colspan="4">
                        <div class="cont" style="height: 310px;">
                            ...
                            <div class="marT10">
                                <ul>
                                    <li><span class="">중심위치 : </span> <c:out value="${result.xcord}"/>, <c:out
