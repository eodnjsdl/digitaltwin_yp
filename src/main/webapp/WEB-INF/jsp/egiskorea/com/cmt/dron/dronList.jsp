...
//         rightPopupOpen('selectDronInfoView');
    ...
    <div class="popup-body">
        ...
        <div class="tool-popup-body">
            <form:form name="searchFormDronList" id="searchFormDronList" method="post" onsubmit="fn_select_dron_list(); return false;">
...
<%--                </div>--%>
                <div class="pagination">
                    <ui:pagination paginationInfo="${paginationInfo}" type="pagination" jsFunction="fn_select_dron_linkPage"/>
                </div>
            </div>
        </div>
