...
<%-- 												<tr>
									...
									<div class="tabBoxDepth1-wrap">
										<div class="tabBoxDepth1">
											<ul>
												<li data-tab="proTab01" class="on"><button type="button" class="inner-tab">지목조사</button></li>
												<li data-tab="proTab02"><button type="button" class="inner-tab">공통항목</button></li>
												<li data-tab="proTab03"><button type="button" class="inner-tab">토지특성</button></li>
												<li data-tab="proTab04"><button type="button" class="inner-tab">주택특성</button></li>
												<li data-tab="proTab05"><button type="button" class="inner-tab">토지피복</button></li>
											</ul>
										</div>
										<!-- 지목조사 -->
										<div class="tab-cont proTab01 on">
											...
											<div class="position-bottom btn-wrap justify-content-end examinationBtn">
												<div><button type="button" class="btn basic bi-edit" onClick="fn_select_update('<c:out value="${result.pnu}" />')">수정</button> <button type="button" class="btn basic bi-excel" onClick="fn_download_excelData(this.form,'<c:out value="${result.pnu}" />')">엑셀저장</button> <button type="button" class="btn basic bi-delete2" onClick="fn_select_delete('<c:out value="${result.orgFid}" />')">삭제</button></div>
											</div>
										</div>
										<!-- //지목조사 -->
										<!-- 공통항목 -->
