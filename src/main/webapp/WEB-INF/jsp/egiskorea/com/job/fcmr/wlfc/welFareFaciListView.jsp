					...
					<div class="srch-default" style="margin-top: 15px;">
						<table class="srch-tbl">
							...
							<tbody id="lSrchOptions">
								...
								<tr>
									<td colspan="2"><input type="text" class="form-control" id="welRnAdres" name="rnAdres" onkeypress="if( event.keyCode == 13 ){ selectWelFareFaciList(1); }" placeholder="도로명주소"></td>
								</tr>
								<tr>
									<td colspan="2"><input type="text" class="form-control" id="welFcltyNm" name="fcltyNm" onkeypress="if( event.keyCode == 13 ){ selectWelFareFaciList(1); }" placeholder="시설명"></td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<div class="items data-area">
			<div class="bbs-top">
				...
				<div>
					...
					<button type="button" class="btn basic bi-excel btn_excel" onclick="welFareFaciExcel();">엑셀저장</button>
				</div>
			</div>
