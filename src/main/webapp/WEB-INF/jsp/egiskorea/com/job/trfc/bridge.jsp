...
<script>
				...
				<!-- 업무 > 시설관리 > 교통시설 > 교량 상세보기 -->
<!-- 				<div id="selectBridge" class="popup-panel popup-sub opened" style="bottom: 398px;right: 70px;width: 550px;height: 459px;"> -->
					<div class="popup-header">교량 상세보기</div>
										...
										<table class="data-detail">
											...
											<tbody>
												<tr>
													...
													<td>${result.bridgeSn}</td>
												</tr>
												<tr>
													<th scope="row">교량명</th>
													<td>${result.korBriNm}</td>
