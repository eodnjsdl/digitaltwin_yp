...
<script>
				...
				<!-- 업무 > 시설관리 > 교통시설 > 지하철선로 상세보기 -->
<!-- 				<div id="selectSubwayTrack" class="popup-panel popup-sub opened" style="bottom: 398px;right: 70px;width: 550px;height: 459px;"> -->
					<div class="popup-header">지하철선로 상세보기</div>
						...
						<div class="sub-popup-body">
							<div class="data-write-wrap" style="height: 442px;">
										...
										<table class="data-detail">
											...
											<tbody>
												<tr>
													...
													<td>${result.subRlwSn}</td>
												</tr>
												<tr>
													<th scope="row">지하철선로명</th>
													<td>${result.korSbrNm}</td>
								...
								<div class="position-bottom btn-wrap">
									<div>
<!-- 										<button type="button" class="btn basic bi-edit" id="subwayTrackUpdate">수정</button>  -->
