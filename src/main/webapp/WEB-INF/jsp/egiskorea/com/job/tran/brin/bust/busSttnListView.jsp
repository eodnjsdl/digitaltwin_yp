...
<!-- js -->
<script src="/js/egiskorea/com/job/tran/brin/bust/busSttn.js"></script>		<!-- 버스정류소 -->

<script>

$(document).ready(function() {
	//console.log("busSttnListView.jsp");
		...
		<div class="items search-area">
			...
			<div class="tabBoxDepth2-wrap">
				...
				<div class="tab-cont busRouteInfoProperty on">
					<div class="srch-default" style="margin-top: 15px;">
						<table class="srch-tbl">
							...
							<tbody id="lSrchOptions">
								...
								<tr>  
									<td colspan="2">
										<input type="text" name="sttn_nm" class="form-control" value="" onkeypress="if( event.keyCode == 13 ){ selectBusSttnList(1); }" placeholder="정류소명">
									</td>
								</tr>
								<tr>  
									<td colspan="2">
										<input type="text" name="sttn_no" class="form-control" value="" onkeypress="if( event.keyCode == 13 ){ selectBusSttnList(1); }" placeholder="정류소번호">
									</td>
								</tr>
							</tbody>
						</table>
					...
					<div class="btn-wrap">
						<div>
							<button type="button" class="btn type01 search info-attribute-search" onclick="selectBusSttnList(1)">조회</button>
						</div>
					</div>
				</div>
