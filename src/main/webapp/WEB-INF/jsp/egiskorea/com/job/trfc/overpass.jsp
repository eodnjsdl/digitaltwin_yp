...
<script>
				...
				<!-- 업무 > 시설관리 > 교통시설 > 고가도로 상세보기 -->
<!-- 				<div id="selectOverpass" class="popup-panel popup-sub opened" style="bottom: 398px;right: 70px;width: 550px;height: 459px;"> -->
					<div class="popup-header">고가도로 상세보기</div>
						...
						<div class="sub-popup-body">
							<div class="data-write-wrap" style="height: 442px;">
								...
								<div class="position-bottom btn-wrap">
									<div>
<!-- 										<button type="button" class="btn basic bi-edit" id="overpassUpdate">수정</button>  -->
