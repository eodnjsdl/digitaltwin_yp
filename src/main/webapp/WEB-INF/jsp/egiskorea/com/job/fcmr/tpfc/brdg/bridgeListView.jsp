...
$(document).ready(function(){
	...
	$(document).on("click", ".tabBoxDepth2-wrap .tabBoxDepth2 > ul > li > .inner-tab", function(){ 
		...
		if($("li[data-tab=bridgeProperty]").hasClass("on")){	//속성검색 일때 공간 검색때 사용한 그리기 초기화
	...
	// 엑셀 다운로드
    $('#downloadExcelBridge').on('click', function () {
		downloadExcelBridge();
	});
});
</script>
	...
	<div class="bottom-popup-body bottom-popup-group">						
		...
		<div class="items search-area">
			...
			<div class="tabBoxDepth2-wrap">
                <div class="tabBoxDepth2">
					<ul>
						<li data-tab="bridgeProperty" class="on">
							<button type="button" class="inner-tab">속성검색</button>
						</li>
						<li data-tab="bridgeSpace">
							<button type="button" class="inner-tab">공간검색</button>
						</li>
					</ul>
				</div>
				<div class="tab-cont bridgeProperty on brdge">
					<div class="srch-default">
						<table class="srch-tbl">
							...
							<tbody id="lSrchOptions">
								...
								<tr>
									<td colspan="2"><input type="text" class="form-control" id="korBriNm" name="korBriNm" placeholder="교량명"></td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="tab-cont bridgeSpace">
		...
		<div class="items data-area">
            <div class="bbs-top">
                ...
                <div>
					<button type="button" class="btn basic bi-excel" id="downloadExcelBridge">엑셀저장</button>
				</div>
            </div>
            <div class="bbs-list-wrap" style="height: 267px;">
                <div class="bbs-default">
                <form:form>
                	<div data-ax5grid="bridgeListGrid" data-ax5grid-config="{}" style="height: 267px;"></div>
...
<button type="button" class="popup-reset" class="초기화" onclick="getTransportationFacility('bridge')"></button>
