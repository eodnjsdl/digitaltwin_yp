								...
								<table class="data-write">
									...
									<tbody>
										<tr>
											...
											<td colspan="3"><input type="text" id="prprtyNo" name="prprtyNo" maxlength="8" value="<c:out value="${pbprtAccdtDtlInfoList.prprtyNo}"/>" placeholder="" class="form-control pbprtAccdtInput"/></td>
										</tr>
										<tr>
