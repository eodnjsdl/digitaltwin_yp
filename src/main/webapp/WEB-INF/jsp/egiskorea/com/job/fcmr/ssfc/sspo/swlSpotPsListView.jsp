...
<!-- js -->
<script src="/js/egiskorea/com/job/fcmr/ssfc/sspo/swlSpotPs.js"></script>

<script>
$(document).ready(function() {
	//console.log("swlSpotPsListView.jsp");	
    ...
    <div class="bottom-popup-body bottom-popup-group">
        ...
        <div class="items search-area">
            <div class="top-search">
                <select class="form-select facility-select">
                    ...
                    <option value="swlSpotPs" selected="selected">물받이</option>
            ...
            <div class="tabBoxDepth2-wrap">
                ...
                <div class="tab-cont groundwaterProperty on">
                    ...
                    <div class="btn-wrap">
                        <div>
                            <button type="button" class="btn type01 search facility-attribute-search" onclick="selectSwlSpotPsList(1)">조회</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="items data-area">
            <div class="bbs-top">
                ...
                <div>
                    <button type="button" class="btn basic bi-write btn_add" onclick="insertSwlSpotPsView();">등록</button>
                    <button type="button" class="btn basic bi-excel btn_excel" onclick="swlSpotPsExcel();">엑셀저장</button>
                </div>
            </div>
...
<button type="button" class="manualBtn" title="도움말" onclick="manualTab('물받이')"></button>
