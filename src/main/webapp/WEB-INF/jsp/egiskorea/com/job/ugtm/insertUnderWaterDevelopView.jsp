...
$("#devRegist").on("click", function(){
	...
	var form = $("#insertUnderWaterDevelopForm")[0];
	...
	if(confirm("<spring:message code="common.regist.msg" />")){	//등록하시겠습니까?
       	...
       	$.ajax({
       		type : "POST",
       		url	 : "/job/ugtm/insertUnderWaterDevelop.do",
       		data : formData,
			processData : false,
			contentType : false,
			dataType: "json",
...
var years = "";
	...
	<div class="popup-header">지하수개발 등록하기</div>
	<div class="popup-body">
		<form:form id="insertUnderWaterDevelopForm" method="post">
		<div class="sub-popup-body">
			<div class="data-write-wrap" style="height: 375px;">
				...
				<div class="position-bottom btn-wrap">
					<div>
						<button type="button" class="btn basic bi-write2" id="devRegist">등록</button> 
