...
$(document).ready(function(){
	...
	$(document).on("click", ".tabBoxDepth2-wrap .tabBoxDepth2 > ul > li > .inner-tab", function(){ 
		...
		if($("li[data-tab=tunnelProperty]").hasClass("on")){	//속성검색 일때 공간 검색때 사용한 그리기 초기화
	...
	// 엑셀 다운로드
    $('#downloadExcelTunnel').on('click', function () {
		downloadExcelTunnel();
	});
});
</script>
	...
	<div class="bottom-popup-body bottom-popup-group">						
		...
		<div class="items search-area">
			...
			<div class="tabBoxDepth2-wrap">
				...
				<div class="tab-cont tunnelProperty on tunnl">
		...
		<div class="items data-area">
            <div class="bbs-top">
                ...
                <div>
					<button type="button" class="btn basic bi-excel" id="downloadExcelTunnel">엑셀저장</button>
				</div>
            </div>
