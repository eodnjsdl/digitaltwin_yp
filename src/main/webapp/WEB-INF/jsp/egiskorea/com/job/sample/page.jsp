...
<script>
    ...
    function call_wfs() {
        ...
        grid.setConfig({
            ...
            columns: [
                {key: "adres", label: "adres", width: 65},
                {key: "calbr", label: "calbr"},
                {key: "detail_prpos_se", label: "detail_prpos_se"},
                {key: "devlop_year", label: "devlop_year"},
                {key: "dph", label: "dph"},
                {key: "dscrgpp_calbr", label: "dscrgpp_calbr"},
                {key: "fclts_chck_de", label: "fclts_chck_de"},
                {key: "fclts_sttus", label: "fclts_sttus"},
                {key: "fclty_nm", label: "fclty_nm"},
                {key: "manage_instt_nm", label: "manage_instt_nm"},
                {key: "manage_se", label: "manage_se"},
                {key: "prpos_se", label: "prpos_se"},
            ]
        });
        options = {
...
<div class="popup-body">
    <div class="bottom-popup-body bottom-popup-group">
        ...
        <div class="items data-area">
            <div class="bbs-top">
                <div class="bbs-list-num"><strong><%-- <c:out value="${resultCnt}"></c:out> --%></strong></div>
                <div>
