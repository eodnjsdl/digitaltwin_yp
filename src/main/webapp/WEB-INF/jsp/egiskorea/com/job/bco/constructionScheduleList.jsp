			...
			<div class="tabBoxDepth1">
				<ul>
					<li data-tab="constructionPlan">
						<button id="constructionPlan" type="button" class="inner-tab leftPopup" data-tab="constructionPlan">공사계획정보</button>
					</li>
					<li data-tab="constructionSchedule" class="on">
						<button id="constructionSchedule" type="button" class="inner-tab leftPopup" data-tab="constructionSchedule">공사예정정보</button>
					</li>
					<li data-tab="constructionInquiry">
						<button id="constructionInquiry" type="button" class="inner-tab leftPopup" data-tab="constructionInquiry">공사정보 조회</button>
					</li>
				</ul>
			</div>
			<!-- 공사예정정보 -->
			<div class="tab-cont constructionSchedule on" id="divConstructionSchedule">
				<form:form name="searchScheduleForm" id="searchScheduleForm" method="post" onsubmit="fn_selectSchedule_linkPage(1); return false;">
						...
						<div class="srch-default">
							<table class="srch-tbl">
								...
								<tbody>
									...
									<tr>
										<th scope="row">공사명</th>
										<td><input type="text" class="form-control" name="cntrkNm" id="cntrkNm" placeholder="공사명을 입력해주세요." value="<c:out value='${searchVO.cntrkNm}' />"></td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="bbs-list-wrap" style="height: 456px;"><!-- pagination 하단 고정을 위해 반드시 필요 -->
							...
							<table class="bbs-list">
								...
								<tbody>
									...
									<c:forEach items="${resultList}" var="csList" varStatus="status">
										<tr name="tdCwsDtl" 
											data-cwsid='<c:out value="${csList.cntrkPrrngId}" ></c:out>'
											...
											<td><c:out value="${csList.plnYear}"></c:out>년 <c:out value="${csList.plnQu}"></c:out></td>
					...
					<div class="pagination">
						<ui:pagination paginationInfo="${paginationInfo}" type="pagination" jsFunction="fn_selectSchedule_linkPage"/>
					</div>
					<!--
					<div class="pagination">
					...
					<div class="btn-wrap"><div><button type="button" class="btn basic bi-delete2">선택삭제</button></div>
					-->
				</div>
			</div>
			<!-- //공사예정정보 -->
