...
// 	console.log(gid)
	sportsFacMngViewPaging(pageNo, gid);
	setPoint(pageNo);
}
</script>

<!-- 업무 > 시설관리 > 체육시설 > 시설정보 관리 -->
<!-- 				<div class="popup-panel popup-sub work-02-04-regist" style="bottom: 398px;right: 70px;width: 550px;height: 459px;"> -->
<div class="popup-panel popup-sub opened" style="bottom: 398px;right: 70px;width: 550px;height: 445px;" id="test2">
		...
		<div class="sub-popup-body">
			<div class="data-write-wrap" style="height: 100%;">
							...
							<tbody>
								<tr>
									...
									<td colspan="3">
										...
										<button type="button" class="btn type01 bi-location" id="" onclick="sporFacSelLocation();">지도에서 선택</button>
									</td>
								</tr>
								<tr>
				...
				<div class="position-bottom btn-wrap">
					<div class="position-absolute left"><button type="button" class="btn basic bi-delete2" onclick="deleteFacSportsMng();">선택삭제</button></div>
					<div>
						<button type="button" class="btn basic bi-write2" onclick="insertSportsFacMngInfo('${gid}');">등록</button>
