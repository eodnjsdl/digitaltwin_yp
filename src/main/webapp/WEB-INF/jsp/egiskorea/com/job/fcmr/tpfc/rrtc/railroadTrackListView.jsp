...
$(document).ready(function(){
	...
	$(document).on("click", ".tabBoxDepth2-wrap .tabBoxDepth2 > ul > li > .inner-tab", function(){ 
		...
		if($("li[data-tab=railroadTrackProperty]").hasClass("on")){	//속성검색 일때 공간 검색때 사용한 그리기 초기화
 ...
 // 엑셀 다운로드
    $('#downloadExcelRailroadTrack').on('click', function () {
		downloadExcelRailroadTrack();
	});
});
</script>
	...
	<div class="bottom-popup-body bottom-popup-group">						
		...
		<div class="items search-area">
			...
			<div class="tabBoxDepth2-wrap">
                <div class="tabBoxDepth2">
					<ul>
						<li data-tab="railroadTrackProperty" class="on">
							<button type="button" class="inner-tab">속성검색</button>
						</li>
						<li data-tab="railroadTrackSpace">
							<button type="button" class="inner-tab">공간검색</button>
						</li>
					</ul>
				</div>
				<div class="tab-cont railroadTrackProperty on rlroadTc">
					<div class="srch-default">
						<table class="srch-tbl">
							...
							<tbody id="lSrchOptions">
								...
								<tr>
									<td colspan="2"><input type="text" class="form-control" id="korRlrNm" name="korRlrNm" placeholder="철도선로명"></td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="tab-cont railroadTrackSpace">
		...
		<div class="items data-area">
            <div class="bbs-top">
                ...
                <div>
					<button type="button" class="btn basic bi-excel" id="downloadExcelRailroadTrack">엑셀저장</button>
				</div>
            </div>
            <div class="bbs-list-wrap" style="height: 267px;">
                <div class="bbs-default">
                <form:form>
                	<div data-ax5grid="rlroadTcListGrid" data-ax5grid-config="{}" style="height: 267px;"></div>
