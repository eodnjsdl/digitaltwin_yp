...
ui.callDatePicker();
// 지하수이용시설 수정하기 버튼
$("#useFacilUpdate").on("click", function(){
	
	var form = $("#updateUnderWaterUseFacilForm")[0];
...
var years = "<c:out value="${result.devlopYear}" />";
	...
	<div class="popup-header">지하수이용시설 수정하기</div>
	<div class="popup-body">
		<form:form id="updateUnderWaterUseFacilForm" method="post">
		<div class="sub-popup-body">
			<div class="data-write-wrap" style="height: 375px;">
									...
									<td>
										<select class="form-select" id="publicPvtesblSe" name="publicPvtesblSe">
											<c:forEach items="${publicPvtesblSeList}" var="publicPvtesblSeList" varStatus="status">
												<option value="<c:out value='${publicPvtesblSeList.publicPvtesblSe}' />" <c:if test="${result.publicPvtesblSe == publicPvtesblSeList.publicPvtesblSe}">selected</c:if>>
				...
				<div class="position-bottom btn-wrap">
					<div>
						<button type="button" class="btn basic bi-write2" id="useFacilUpdate">수정완료</button> 
