...
<style type="text/css">
	.popup-panel.popup-sub .insert-swlPipeAs-popup-close {
	    top: 0;
	    right: 0;
	    width: 39px;
	    height: 39px;
...
<!-- 업무 > 시설관리 > 하수도시설 > 면형하수관거 등록하기-->
       	<div class="popup-header">면형하수관거 등록하기</div>
           <div class="popup-body">
               <div class="sub-popup-body">
                   <div class="data-write-wrap" style="height: 100%;">
                       <div class="scroll-y">
                       	   <form id="insertSwlPipeAsForm" method="post">
                                   ...
                                   <tr>
                                       ...
                                       <td>
                                          	<select name="ftr_cde" class="form-select" readonly="readonly">
                                          		<option value="SB901" selected="selected">면형암거</option>
                                          		<option value="SB902">면형개거</option>
                                          	</select>
                                       </td>
                       ...
                       <div class="position-bottom btn-wrap">
                           <div>
                           	    <button type="button" class="btn basic bi-edit btn_add" onclick="insertSwlPipeAs();">등록</button>
                           		<button type="button" class="btn basic bi-cancel btn_cancel" onclick="cancelInsertSwlPipeAs()">취소</button>
                           </div>
                       </div>
                   </div>
               </div>
           ...
           <button type="button" class="insert-swlPipeAs-popup-close" title="닫기" onclick="cancelMode();"></button>

<!-- 업무 > 시설관리 > 상수수도시설 > 면형하수관거 등록하기 end -->

<script type="text/javascript">
	//jqeury
	$(document).ready(function(){
		//console.log("insertSwlPipeAsView.jsp");
        ...
        $(".btn-select-map", this).on("click", function () {
     	...
     	//등록창 닫기
     	$(".popup-panel .insert-swlPipeAs-popup-close").on("click", function () {
             cancelInsertSwlPipeAs();
     	});
     	
	});
	
	//취소 버튼 동작
	function cancelInsertSwlPipeAs() {
		//console.log("cancelInsertSwlPipeAs()");
		
		$(".insert-swlPipeAs-popup-close").closest('.popup-panel').removeClass('opened');
        // 초기화 (지도)
        dtmap.draw.dispose();
        dtmap.draw.clear();
