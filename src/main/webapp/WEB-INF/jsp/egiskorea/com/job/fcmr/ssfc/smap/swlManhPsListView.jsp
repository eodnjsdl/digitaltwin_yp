...
<!-- js -->
<script src="/js/egiskorea/com/job/fcmr/ssfc/smap/swlManhPs.js"></script>

<script>
$(document).ready(function() {
	//console.log("swlManhPsListView.jsp");	
    ...
    <div class="bottom-popup-body bottom-popup-group">
        ...
        <div class="items search-area">
            <div class="top-search">
                <select class="form-select facility-select">
                    ...
                    <option value="swlManhPs" selected="selected">하수맨홀</option>
            ...
            <div class="tabBoxDepth2-wrap">
                ...
                <div class="tab-cont groundwaterProperty on">
                    ...
                    <div class="btn-wrap">
                        <div>
                            <button type="button" class="btn type01 search facility-attribute-search" onclick="selectSwlManhPsList(1)">조회</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="items data-area">
            <div class="bbs-top">
                ...
                <div>
                    <button type="button" class="btn basic bi-write btn_add" onclick="insertSwlManhPsView();">등록</button>
                    <button type="button" class="btn basic bi-excel btn_excel" onclick="swlManhPsExcel();">엑셀저장</button>
                </div>
            </div>
...
<button type="button" class="manualBtn" title="도움말" onclick="manualTab('하수맨홀')"></button>
