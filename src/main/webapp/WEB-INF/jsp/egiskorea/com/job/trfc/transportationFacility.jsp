...
<!-- 				<div id="selectRoadSection" class="popup-panel popup-sub opened" style="bottom: 398px;right: 70px;width: 550px;height: 459px;"> -->
						...
						<div class="sub-popup-body">
							<div class="data-write-wrap" style="height: 100%;padding-bottom:0px!important;">
								...
								<!-- <div class="position-bottom btn-wrap">
									<div>
										<button type="button" class="btn basic bi-edit" id="trasnportationFacilityUpdate">수정</button> 
										<button type="button" class="btn basic bi-cancel">취소</button>
									</div>
								</div> -->
								<!-- // class="position-bottom btn-wrap" -->
