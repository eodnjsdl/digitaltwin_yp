...
$(document).ready(function(){
	...
	$(document).on("click", ".tabBoxDepth2-wrap .tabBoxDepth2 > ul > li > .inner-tab", function(){ 
		...
		if($("li[data-tab=overpassProperty]").hasClass("on")){	//속성검색 일때 공간 검색때 사용한 그리기 초기화
    ...
    $(".area-facility-buffer", "#bottomPopup").on("keyup", function (event) {
 	...
 	// 엑셀 다운로드
    $('#downloadExcelOverpass').on('click', function () {
		downloadExcelOverpass();
	});
});
</script>
	...
	<div class="bottom-popup-body bottom-popup-group">						
		...
		<div class="items search-area">
			...
			<div class="tabBoxDepth2-wrap">
                <div class="tabBoxDepth2">
					<ul>
						<li data-tab="overpassProperty" class="on">
							<button type="button" class="inner-tab">속성검색</button>
						</li>
						<li data-tab="overpassSpace">
							<button type="button" class="inner-tab">공간검색</button>
						</li>
					</ul>
				</div>
				<div class="tab-cont overpassProperty on ovrpass">
					<div class="srch-default">
						<table class="srch-tbl">
							...
							<tbody id="lSrchOptions">
								...
								<tr>
									<td colspan="2"><input type="text" class="form-control" id="korOveNm" name="korOveNm" placeholder="교량명"></td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="tab-cont overpassSpace">
					<div class="space-search-group">
						...
						<div class="space-search-items">경계로부터
							<span class="form-group">
								<input type="text" onkeyup = "this.value=this.value.replace(/[^-0-9]/g,'');" class="form-control align-center" name="bufferCnt" id="bufferCnt" value="0" placeholder="0">
									<sub>m</sub>
							</span> 이내 범위
						</div>
					</div>
		...
		<div class="items data-area">
            <div class="bbs-top">
                ...
                <div>
					<button type="button" class="btn basic bi-excel" id="downloadExcelOverpass">엑셀저장</button>
				</div>
            </div>
            <div class="bbs-list-wrap" style="height: 267px;">
                <div class="bbs-default">
                <form:form>
                	<div data-ax5grid="overpassListGrid" data-ax5grid-config="{}" style="height: 267px;"></div>
