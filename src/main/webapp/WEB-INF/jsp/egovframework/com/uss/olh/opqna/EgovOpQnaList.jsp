...
function fn_egov_select_linkPage(pageNo){
	...
	document.qnaForm.action = "<c:url value='/uss/olh/opqna/selectOpQnaList.do'/>";
...
function fn_egov_inquire_qnadetail(qaId) {
	...
	document.qnaForm.qaId.value = qaId;
  	document.qnaForm.action = "<c:url value='/uss/olh/opqna/selectOpQnaDetail.do'/>";
  	document.qnaForm.submit();
}
</script>
</head>
...
<form name="qnaForm" action="<c:url value='/uss/olh/opqna/selectOpQnaList.do'/>" method="post" onSubmit="fn_egov_search_qna(); return false;"> 
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olh/opqna/insertOpQnaView.do' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	</form>
	...
	<tr>
		...
		<td>
			<form name="subForm" method="post" action="<c:url value='/uss/olh/opqna/selectOpQnaDetail.do'/>">
