...
<form name="qnaForm" action="<c:url value='/uss/olh/opqna/updateOpQnaAnswerView.do'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/opqna/selectOpQnaAnswerList.do' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
