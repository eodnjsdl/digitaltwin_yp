function commonnessCodeList(code, target){	
	if(code == ""){
...
function manualImport() {
	let content = `<div class="manual-panel">
	...
	$('.popup-overlay').after(content);
	$('.manual-close').after(contentScript);
	
};


function manualTab(txt) {
	window.open('/userManual.do?txt='+txt);
}