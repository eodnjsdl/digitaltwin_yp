...
class SelectLdbdList {
    ...
    onDrawEnd(e) {
        ...
        var options = {
            typeNames: 'lsmd_cont_ldreg_41830',
            geometry : geom,
        }
        that.feature = e.origin.feature;
        // setTimeout(() => {
        ...
        promise.then(function (data) {
            ...
            console.log(data)
            that.createResults(data.totalFeatures, data.features);


        });
        // yMap.getModule("highlight").addFeature("sky", that.feature);
        // dtmap.vector.addFeatures(that.feature);
    ...
    mapevent(data) {
        ...
        dtmap.on('drawend', that.onDrawEnd);
    ...
    getAreaFilter() {
        ...
        //     ).val();
            ...
            // if (searchAreaType == "extent") {
                ...
                // geometry = ol.geom.Polygon.fromExtent(dtmap.getExtent());
                // geometry = cmmUtil.toSystemProjection(geometry);
